...
const UpdateAppointmentBodyDTOSchema = Type.Object(
    {
...
const UpdateAppointmentParametersDTOSchema = Type.Object(
    {
...
const validateParameters = ajv.compile(UpdateAppointmentParametersDTOSchema);
const validateBody = ajv.compile(UpdateAppointmentBodyDTOSchema);

const validateUpdateAppointmentDTO = (req, res, next) => {
...
export default {
    UpdateAppointmentBodyDTOSchema,
    UpdateAppointmentParametersDTOSchema,
